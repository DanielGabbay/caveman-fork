...
#
# One-line install:
#   curl -fsSL https://raw.githubusercontent.com/DanielGabbay/caveman-fork/main/install.sh | bash
#   curl -fsSL https://raw.githubusercontent.com/DanielGabbay/caveman-fork/main/install.sh | bash -s -- --all
#
# Local clone:
