...
//   curl|bash:   delegated from install.sh shim → npx -y github:DanielGabbay/caveman-fork -- [flags]
...
const REPO = 'DanielGabbay/caveman-fork';
...
USAGE
  npx -y github:DanielGabbay/caveman-fork -- [flags]
...
EXAMPLES
  npx -y github:DanielGabbay/caveman-fork                        # default install
  npx -y github:DanielGabbay/caveman-fork -- --all               # all the trimmings
  npx -y github:DanielGabbay/caveman-fork -- --only claude --no-mcp-shrink
  npx -y github:DanielGabbay/caveman-fork -- --uninstall
